...
const searchForm = () => (
    ...
    <span className='input-group-text'>
        <div className='input-group input-group-lg serachBox'>
        ...
        <TextField
            ...
            id='outlined-basic'
            label={<span className='labelSearch'><SearchIcon/>Search by name</span>}
            variant='outlined'
        ...
        <div className='ml-3 mt-2' style={{ border: 'none' }}>
            <Button ml={2} variant='contained' className='searchBtn' type='submit'>
            Search
            </Button>
        </div>
        </div>
