...
const renderMobileMenu = (
    ...
    <div style={{ backgroundColor: '#404040' }}>
        ...
        <MenuItem>
            <Link
            style={isActive(history, '/user/order')}
            to='/user/dashboard'
            >
            <IconButton aria-label='Dashboard' color='inherit'>
                <DashboardIcon />
...
return (
    ...
    <AppBar position='fixed' className={`headers ${scroll ? "active":"not"}`}>
        ...
        <div className={classes.sectionDesktop}>
            ...
            <Link style={isActive(history, '/shop')} to='/shop' className='Navli'>
            <Tooltip title="Shop">
                <IconButton aria-label='Shop' color='inherit'>
                    <StorefrontIcon />
            ...
            <Link style={isActive(history, '/cart')} to='/cart' className='Navli'>
            <Tooltip title="Cart">
            <IconButton aria-label='Cart' color='inherit'>
                <Badge badgeContent={itemTotal()} color='secondary'>
                <ShoppingCartOutlinedIcon />
            ...
            >
                <Tooltip title="Order">
                    <IconButton aria-label='Order' color='inherit'>
                    <ChangeHistoryIcon />
